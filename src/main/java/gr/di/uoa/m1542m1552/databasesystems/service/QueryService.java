...
public class QueryService {
    ...
    public AggregationResults<Request> query2(String typeOfServiceRequest, Date creationDate, Date completionDate) {
        ...
        AggregationResults<Request> result = mongoTemplate.aggregate(aggregation, "zips", Request.class);
